...
class Article_model extends CI_Model
{
	...
	$query=$this->db->query("select * from t_article where article_id=$article_id");
	return $query;
	// redirct('admin/views/main.php');
	}
	public function save_message($array){
		$query=$this->db->insert('t_message', $array);
		return $query;
	}
